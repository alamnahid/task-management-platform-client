...
const HowItWorks = () => {
    ...
    return (
        <div>
            ...
            <div className="flex flex-col-reverse lg:flex-row mx-[3%] lg:mx-[10%] my-8 lg:my-32 justify-center items-center gap-8 lg:gap-20">
                <div className="flex-1">
                    ...
                    <ul className="mt-5">
                        <li className="flex mont items-center gap-2"><FaArrowRight /> No credit card required</li>
                        <li className="flex mont items-center gap-2 mt-2"><FaArrowRight /> Unlimited users</li>
                        <li className="flex mont items-center gap-2 mt-2"><FaArrowRight /> Free forever</li>
                    </ul>
            ...
            <div className="flex flex-col lg:flex-row mx-[3%] lg:mx-[10%] my-8 lg:my-32 justify-center items-center gap-8 lg:gap-20">
                <div className="flex-1">
                ...
                <div className="flex-1">
                    ...
                    <ul className="mt-5">
                        <li className="flex mont items-center gap-2"><FaArrowRight /> Comprehensive Task Details</li>
                        <li className="flex mont items-center gap-2 mt-2"><FaArrowRight /> Subtasks for Better Organization</li>
                        <li className="flex mont items-center gap-2 mt-2"><FaArrowRight /> Edit and Delete Tasks</li>
                    </ul>
                    <Link to={user ? '/dashboard/dashboardhome' : '/login'}><button className="capitalize w-[14rem] md:w-[18rem] h-14 border-2 border-[#fd7a38c9] rounded-lg text-[#FD7B38] font-medium mt-8 text-base md:text-2xl mont hover:bg-black hover:border-none hover:text-white">Get For Free</button></Link>
                </div>
            ...
            <div className="flex flex-col-reverse lg:flex-row mx-[3%] lg:mx-[10%] my-8 lg:my-32 justify-center items-center gap-8 lg:gap-20">
                ...
                <div className="flex-1">
                    ...
                    <ul className="mt-5">
                        <li className="flex mont items-center gap-2"><FaArrowRight /> Intuitive Task Status Updates</li>
                        <li className="flex mont items-center gap-2 mt-2"><FaArrowRight /> Visual Progress Tracking</li>
                        <li className="flex mont items-center gap-2 mt-2"><FaArrowRight /> Customizable Prioritization</li>
                    </ul>
                    <Link to={user ? '/dashboard/dashboardhome' : '/login'}><button className="capitalize w-[14rem] md:w-[18rem] h-14 border-2 border-[#fd7a38c9] rounded-lg text-[#FD7B38] font-medium mt-8 text-base md:text-2xl mont hover:bg-black hover:border-none hover:text-white">Get For Free</button></Link>
                </div>
                <div className="flex-1">
